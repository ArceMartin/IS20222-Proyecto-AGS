...
//Pruebas para la funcion ingresas una cadena y te retorna el numero de veces que aparece una palabra
//ejemplo: str="Un circulo es una figura de forma redonda" ==> Un: 1, circulo: 1 
...
let a=wordCount('Este es un ejemplo de conteo de frecuencia de palabras');
console.log(a)
...
function getBigrams(str) {
  ...
  let r=getBigrams("Hola esto es un ejemplo");
  console.log(r);
  let z=getBigrams("Hola esto es una broma");
  console.log(z);
...
xc=diceCoefficient("Un triangulo es una figura de tres lados", "Un triangulo tiene 3 lados");
console.log(xc);